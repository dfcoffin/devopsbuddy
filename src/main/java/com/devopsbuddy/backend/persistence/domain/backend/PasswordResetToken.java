...
public class PasswordResetToken implements Serializable {
     ...
     * @param expirationInMinutes The length, in minutes, for wich this token will be valid.  If zero, it will be
     *                            assigned a default value of 120 (2 hours)
     * @throws IllegalArgumentException If the token, user or creation date are null
     */
