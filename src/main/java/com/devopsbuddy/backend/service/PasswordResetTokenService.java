...
public class PasswordResetTokenService {
     ...
     * @return a new Password ResetToken for the user identified by the given email or null if none was found.
     */
    @Transactional
     ...
     * @return A Password ResetToken if one was found or null if none was found.
     */
